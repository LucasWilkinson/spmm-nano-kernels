...
namespace sop {
struct MicroKernel_float_64487_AVX2_256_4x4 {
        ...
        const bool load_c)
    {
      ...
      if (load_c) {
        ...
        cVec01 = _mm256_loadu_ps(C0 + 1 * 8);
        cVec02 = _mm256_loadu_ps(C0 + 2 * 8);
        cVec03 = _mm256_loadu_ps(C0 + 3 * 8);
        cVec10 = _mm256_loadu_ps(C1 + 0 * 8);
        cVec11 = _mm256_loadu_ps(C1 + 1 * 8);
        cVec12 = _mm256_loadu_ps(C1 + 2 * 8);
        cVec13 = _mm256_loadu_ps(C1 + 3 * 8);
        cVec20 = _mm256_loadu_ps(C2 + 0 * 8);
        cVec21 = _mm256_loadu_ps(C2 + 1 * 8);
        cVec22 = _mm256_loadu_ps(C2 + 2 * 8);
        cVec23 = _mm256_loadu_ps(C2 + 3 * 8);
        cVec30 = _mm256_loadu_ps(C3 + 0 * 8);
        cVec31 = _mm256_loadu_ps(C3 + 1 * 8);
        cVec32 = _mm256_loadu_ps(C3 + 2 * 8);
        cVec33 = _mm256_loadu_ps(C3 + 3 * 8);
      } else {
      ...
      _mm256_storeu_ps(C0 + 1 * 8, cVec01);
      _mm256_storeu_ps(C0 + 2 * 8, cVec02);
      _mm256_storeu_ps(C0 + 3 * 8, cVec03);
      _mm256_storeu_ps(C1 + 0 * 8, cVec10);
      _mm256_storeu_ps(C1 + 1 * 8, cVec11);
      _mm256_storeu_ps(C1 + 2 * 8, cVec12);
      _mm256_storeu_ps(C1 + 3 * 8, cVec13);
      _mm256_storeu_ps(C2 + 0 * 8, cVec20);
      _mm256_storeu_ps(C2 + 1 * 8, cVec21);
      _mm256_storeu_ps(C2 + 2 * 8, cVec22);
      _mm256_storeu_ps(C2 + 3 * 8, cVec23);
      _mm256_storeu_ps(C3 + 0 * 8, cVec30);
      _mm256_storeu_ps(C3 + 1 * 8, cVec31);
      _mm256_storeu_ps(C3 + 2 * 8, cVec32);
      _mm256_storeu_ps(C3 + 3 * 8, cVec33);
        ...
        const bool load_c)
    {
      ...
      if (load_c) {
        ...
        cVec01 = _mm256_load_ps(C0 + 1 * 8);
        cVec02 = _mm256_load_ps(C0 + 2 * 8);
        cVec03 = _mm256_load_ps(C0 + 3 * 8);
        cVec10 = _mm256_load_ps(C1 + 4 * 8);
        cVec11 = _mm256_load_ps(C1 + 5 * 8);
        cVec12 = _mm256_load_ps(C1 + 6 * 8);
        cVec13 = _mm256_load_ps(C1 + 7 * 8);
        cVec20 = _mm256_load_ps(C2 + 8 * 8);
        cVec21 = _mm256_load_ps(C2 + 9 * 8);
        cVec22 = _mm256_load_ps(C2 + 10 * 8);
        cVec23 = _mm256_load_ps(C2 + 11 * 8);
        cVec30 = _mm256_load_ps(C3 + 12 * 8);
        cVec31 = _mm256_load_ps(C3 + 13 * 8);
        cVec32 = _mm256_load_ps(C3 + 14 * 8);
        cVec33 = _mm256_load_ps(C3 + 15 * 8);
      } else {
        cVec00 = _mm256_setzero_ps();
        cVec01 = _mm256_setzero_ps();
        cVec02 = _mm256_setzero_ps();
