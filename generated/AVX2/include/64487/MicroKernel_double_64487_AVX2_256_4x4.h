...
namespace sop {
struct MicroKernel_double_64487_AVX2_256_4x4 {
    ...
    static constexpr int N_r = 4 * 4;
    static constexpr int N_r_reg = 4;
    static constexpr int vec_width_bits = 256;
    static constexpr const char* id = "64487_AVX2_256_4x4";
    static int max_acc_width_in_vecs() { return 4; };
    static int max_acc_width_in_eles() { return 4 * 4; };
        ...
        const bool load_c)
    {
      ...
      if (load_c) {
        ...
        cVec01 = _mm256d_loadu_pd(C0 + 1 * 4);
        cVec02 = _mm256d_loadu_pd(C0 + 2 * 4);
        cVec03 = _mm256d_loadu_pd(C0 + 3 * 4);
        cVec10 = _mm256d_loadu_pd(C1 + 0 * 4);
        cVec11 = _mm256d_loadu_pd(C1 + 1 * 4);
        cVec12 = _mm256d_loadu_pd(C1 + 2 * 4);
        cVec13 = _mm256d_loadu_pd(C1 + 3 * 4);
        cVec20 = _mm256d_loadu_pd(C2 + 0 * 4);
        cVec21 = _mm256d_loadu_pd(C2 + 1 * 4);
        cVec22 = _mm256d_loadu_pd(C2 + 2 * 4);
        cVec23 = _mm256d_loadu_pd(C2 + 3 * 4);
        cVec30 = _mm256d_loadu_pd(C3 + 0 * 4);
        cVec31 = _mm256d_loadu_pd(C3 + 1 * 4);
        cVec32 = _mm256d_loadu_pd(C3 + 2 * 4);
        cVec33 = _mm256d_loadu_pd(C3 + 3 * 4);
      } else {
        cVec00 = _mm256d_setzero_pd();
        cVec01 = _mm256d_setzero_pd();
        cVec02 = _mm256d_setzero_pd();
        cVec03 = _mm256d_setzero_pd();
        cVec10 = _mm256d_setzero_pd();
        cVec11 = _mm256d_setzero_pd();
        cVec12 = _mm256d_setzero_pd();
        cVec13 = _mm256d_setzero_pd();
        cVec20 = _mm256d_setzero_pd();
        cVec21 = _mm256d_setzero_pd();
        cVec22 = _mm256d_setzero_pd();
        cVec23 = _mm256d_setzero_pd();
        cVec30 = _mm256d_setzero_pd();
        cVec31 = _mm256d_setzero_pd();
        cVec32 = _mm256d_setzero_pd();
        cVec33 = _mm256d_setzero_pd();
      }
      ...
      for(int pat_count = nkern_counts[0]; pat_count > 0; pat_count--) {
        ...
        __m256 bVec1 = _mm256d_loadu_pd(B_curr + 1 * 4);
        __m256 bVec2 = _mm256d_loadu_pd(B_curr + 2 * 4);
        __m256 bVec3 = _mm256d_loadu_pd(B_curr + 3 * 4);
        ...
        cVec01 = _mm256d_fmadd_pd(aVec, bVec1, cVec01);
        cVec02 = _mm256d_fmadd_pd(aVec, bVec2, cVec02);
        cVec03 = _mm256d_fmadd_pd(aVec, bVec3, cVec03);
      ...
      for(int pat_count = nkern_counts[1]; pat_count > 0; pat_count--) {
        ...
        cVec11 = _mm256d_fmadd_pd(aVec, bVec1, cVec11);
        cVec12 = _mm256d_fmadd_pd(aVec, bVec2, cVec12);
        cVec13 = _mm256d_fmadd_pd(aVec, bVec3, cVec13);
      ...
      for(int pat_count = nkern_counts[2]; pat_count > 0; pat_count--) {
        ...
        cVec21 = _mm256d_fmadd_pd(aVec, bVec1, cVec21);
        cVec22 = _mm256d_fmadd_pd(aVec, bVec2, cVec22);
        cVec23 = _mm256d_fmadd_pd(aVec, bVec3, cVec23);
      ...
      for(int pat_count = nkern_counts[3]; pat_count > 0; pat_count--) {
        ...
        cVec31 = _mm256d_fmadd_pd(aVec, bVec1, cVec31);
        cVec32 = _mm256d_fmadd_pd(aVec, bVec2, cVec32);
        cVec33 = _mm256d_fmadd_pd(aVec, bVec3, cVec33);
      ...
      _mm256d_storeu_pd(C0 + 1 * 4, cVec01);
      _mm256d_storeu_pd(C0 + 2 * 4, cVec02);
      _mm256d_storeu_pd(C0 + 3 * 4, cVec03);
      _mm256d_storeu_pd(C1 + 0 * 4, cVec10);
      _mm256d_storeu_pd(C1 + 1 * 4, cVec11);
      _mm256d_storeu_pd(C1 + 2 * 4, cVec12);
      _mm256d_storeu_pd(C1 + 3 * 4, cVec13);
      _mm256d_storeu_pd(C2 + 0 * 4, cVec20);
      _mm256d_storeu_pd(C2 + 1 * 4, cVec21);
      _mm256d_storeu_pd(C2 + 2 * 4, cVec22);
      _mm256d_storeu_pd(C2 + 3 * 4, cVec23);
      _mm256d_storeu_pd(C3 + 0 * 4, cVec30);
      _mm256d_storeu_pd(C3 + 1 * 4, cVec31);
      _mm256d_storeu_pd(C3 + 2 * 4, cVec32);
      _mm256d_storeu_pd(C3 + 3 * 4, cVec33);
        ...
        const bool load_c)
    {
      ...
      if (load_c) {
        ...
        cVec01 = _mm256d_load_pd(C0 + 1 * 4);
        cVec02 = _mm256d_load_pd(C0 + 2 * 4);
        cVec03 = _mm256d_load_pd(C0 + 3 * 4);
        cVec10 = _mm256d_load_pd(C1 + 4 * 4);
        cVec11 = _mm256d_load_pd(C1 + 5 * 4);
        cVec12 = _mm256d_load_pd(C1 + 6 * 4);
        cVec13 = _mm256d_load_pd(C1 + 7 * 4);
        cVec20 = _mm256d_load_pd(C2 + 8 * 4);
        cVec21 = _mm256d_load_pd(C2 + 9 * 4);
        cVec22 = _mm256d_load_pd(C2 + 10 * 4);
        cVec23 = _mm256d_load_pd(C2 + 11 * 4);
        cVec30 = _mm256d_load_pd(C3 + 12 * 4);
        cVec31 = _mm256d_load_pd(C3 + 13 * 4);
        cVec32 = _mm256d_load_pd(C3 + 14 * 4);
        cVec33 = _mm256d_load_pd(C3 + 15 * 4);
      } else {
        cVec00 = _mm256d_setzero_pd();
        cVec01 = _mm256d_setzero_pd();
        cVec02 = _mm256d_setzero_pd();
