...
namespace sop {
struct MicroKernel_float_77f9d_AVX2_8x1 {
    ...
    static constexpr int N_r = 1 * 8;
    static constexpr int N_r_reg = 1;
    static constexpr int vec_width_bits = 256;
    static constexpr const char* id = "77f9d_AVX2_8x1";
    static int max_acc_width_in_vecs() { return 1; };
    static int max_acc_width_in_eles() { return 1 * 8; };
        ...
        const bool load_c)
    {
      ...
      if (load_c) {
        ...
        cVec10 = _mm256_load_ps(C + 1 * 8);
        cVec20 = _mm256_load_ps(C + 2 * 8);
        cVec30 = _mm256_load_ps(C + 3 * 8);
        cVec40 = _mm256_load_ps(C + 4 * 8);
        cVec50 = _mm256_load_ps(C + 5 * 8);
        cVec60 = _mm256_load_ps(C + 6 * 8);
        cVec70 = _mm256_load_ps(C + 7 * 8);
      } else {
        cVec00 = _mm256_setzero_ps();
        cVec10 = _mm256_setzero_ps();
        cVec20 = _mm256_setzero_ps();
      ...
      _mm256_store_ps(C + 1 * 8, cVec10);
      _mm256_store_ps(C + 2 * 8, cVec20);
      _mm256_store_ps(C + 3 * 8, cVec30);
      _mm256_store_ps(C + 4 * 8, cVec40);
      _mm256_store_ps(C + 5 * 8, cVec50);
      _mm256_store_ps(C + 6 * 8, cVec60);
      _mm256_store_ps(C + 7 * 8, cVec70);
