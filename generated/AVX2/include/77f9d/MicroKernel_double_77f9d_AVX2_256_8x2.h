...
namespace sop {
struct MicroKernel_double_77f9d_AVX2_256_8x2 {
    ...
    static constexpr const char* id = "77f9d_AVX2_256_8x2";
        ...
        const bool load_c)
    {
      ...
      if (load_c) {
        ...
        cVec41 = _mm256d_loadu_pd(C4 + 1 * 4);
        cVec50 = _mm256d_loadu_pd(C5 + 0 * 4);
        cVec51 = _mm256d_loadu_pd(C5 + 1 * 4);
        cVec60 = _mm256d_loadu_pd(C6 + 0 * 4);
        cVec61 = _mm256d_loadu_pd(C6 + 1 * 4);
        cVec70 = _mm256d_loadu_pd(C7 + 0 * 4);
        cVec71 = _mm256d_loadu_pd(C7 + 1 * 4);
      } else {
        ...
        cVec41 = _mm256d_setzero_pd();
        cVec50 = _mm256d_setzero_pd();
        cVec51 = _mm256d_setzero_pd();
        cVec60 = _mm256d_setzero_pd();
        cVec61 = _mm256d_setzero_pd();
        cVec70 = _mm256d_setzero_pd();
        cVec71 = _mm256d_setzero_pd();
      }
      ...
      for(int pat_count = nkern_counts[0]; pat_count > 0; pat_count--) {
        ...
        cVec71 = _mm256d_fmadd_pd(aVec, bVec1, cVec71);
      ...
      for(int pat_count = nkern_counts[5]; pat_count > 0; pat_count--) {
        ...
        cVec41 = _mm256d_fmadd_pd(aVec, bVec1, cVec41);
      ...
      for(int pat_count = nkern_counts[6]; pat_count > 0; pat_count--) {
        ...
        cVec51 = _mm256d_fmadd_pd(aVec, bVec1, cVec51);
      ...
      for(int pat_count = nkern_counts[7]; pat_count > 0; pat_count--) {
        ...
        cVec61 = _mm256d_fmadd_pd(aVec, bVec1, cVec61);
      ...
      _mm256d_storeu_pd(C4 + 1 * 4, cVec41);
      _mm256d_storeu_pd(C5 + 0 * 4, cVec50);
      _mm256d_storeu_pd(C5 + 1 * 4, cVec51);
      _mm256d_storeu_pd(C6 + 0 * 4, cVec60);
      _mm256d_storeu_pd(C6 + 1 * 4, cVec61);
      _mm256d_storeu_pd(C7 + 0 * 4, cVec70);
      _mm256d_storeu_pd(C7 + 1 * 4, cVec71);
        ...
        const bool load_c)
    {
      ...
      if (load_c) {
        ...
        cVec10 = _mm256d_load_pd(C1 + 2 * 4);
        cVec11 = _mm256d_load_pd(C1 + 3 * 4);
        cVec20 = _mm256d_load_pd(C2 + 4 * 4);
        cVec21 = _mm256d_load_pd(C2 + 5 * 4);
        cVec30 = _mm256d_load_pd(C3 + 6 * 4);
        cVec31 = _mm256d_load_pd(C3 + 7 * 4);
        cVec40 = _mm256d_load_pd(C4 + 8 * 4);
        cVec41 = _mm256d_load_pd(C4 + 9 * 4);
        cVec50 = _mm256d_load_pd(C5 + 10 * 4);
        cVec51 = _mm256d_load_pd(C5 + 11 * 4);
        cVec60 = _mm256d_load_pd(C6 + 12 * 4);
        cVec61 = _mm256d_load_pd(C6 + 13 * 4);
        cVec70 = _mm256d_load_pd(C7 + 14 * 4);
        cVec71 = _mm256d_load_pd(C7 + 15 * 4);
      } else {
        cVec00 = _mm256d_setzero_pd();
        cVec01 = _mm256d_setzero_pd();
        cVec10 = _mm256d_setzero_pd();
