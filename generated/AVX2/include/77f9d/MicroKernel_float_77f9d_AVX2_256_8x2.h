...
namespace sop {
struct MicroKernel_float_77f9d_AVX2_256_8x2 {
        ...
        const bool load_c)
    {
      ...
      if (load_c) {
        ...
        cVec41 = _mm256_loadu_ps(C4 + 1 * 8);
        cVec50 = _mm256_loadu_ps(C5 + 0 * 8);
        cVec51 = _mm256_loadu_ps(C5 + 1 * 8);
        cVec60 = _mm256_loadu_ps(C6 + 0 * 8);
        cVec61 = _mm256_loadu_ps(C6 + 1 * 8);
        cVec70 = _mm256_loadu_ps(C7 + 0 * 8);
        cVec71 = _mm256_loadu_ps(C7 + 1 * 8);
      } else {
      ...
      _mm256_storeu_ps(C4 + 1 * 8, cVec41);
      _mm256_storeu_ps(C5 + 0 * 8, cVec50);
      _mm256_storeu_ps(C5 + 1 * 8, cVec51);
      _mm256_storeu_ps(C6 + 0 * 8, cVec60);
      _mm256_storeu_ps(C6 + 1 * 8, cVec61);
      _mm256_storeu_ps(C7 + 0 * 8, cVec70);
      _mm256_storeu_ps(C7 + 1 * 8, cVec71);
        ...
        const bool load_c)
    {
      ...
      if (load_c) {
        ...
        cVec10 = _mm256_load_ps(C1 + 2 * 8);
        cVec11 = _mm256_load_ps(C1 + 3 * 8);
        cVec20 = _mm256_load_ps(C2 + 4 * 8);
        cVec21 = _mm256_load_ps(C2 + 5 * 8);
        cVec30 = _mm256_load_ps(C3 + 6 * 8);
        cVec31 = _mm256_load_ps(C3 + 7 * 8);
        cVec40 = _mm256_load_ps(C4 + 8 * 8);
        cVec41 = _mm256_load_ps(C4 + 9 * 8);
        cVec50 = _mm256_load_ps(C5 + 10 * 8);
        cVec51 = _mm256_load_ps(C5 + 11 * 8);
        cVec60 = _mm256_load_ps(C6 + 12 * 8);
        cVec61 = _mm256_load_ps(C6 + 13 * 8);
        cVec70 = _mm256_load_ps(C7 + 14 * 8);
        cVec71 = _mm256_load_ps(C7 + 15 * 8);
      } else {
        cVec00 = _mm256_setzero_ps();
        cVec01 = _mm256_setzero_ps();
        cVec10 = _mm256_setzero_ps();
