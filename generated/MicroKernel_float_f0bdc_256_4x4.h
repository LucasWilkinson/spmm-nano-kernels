...
namespace sop {
struct MicroKernel_float_f0bdc_256_4x4 {
    ...
    static uint16_t encode_nkern_pattern(uint16_t nkern_pat) {
        ...
        if (nkern_pat == 0b00001011) return 4;
        if (nkern_pat == 0b00001101) return 5;
    ...
    static uint16_t decode_nkern_pattern(uint16_t nkern_code) {
        ...
        if (nkern_code == 4) return 0b00001011;
    ...
    static constexpr const char* id = "f0bdc_256_4x4";
