...
namespace sop {
struct MicroKernel_float_c22a5_NEON_128_4x4 {
    ...
    static constexpr const char* id = "c22a5_NEON_128_4x4";
        ...
        const bool load_c)
    {
      ...
      for(int pat_count = nkern_counts[0]; pat_count > 0; pat_count--) {
        ...
        float32x4_t bVec3 = vld1q_f32(B_curr + 3 * 4);
        ...
        cVec03 = vfmaq_f32(cVec03, aVec, bVec3);
      ...
      for(int pat_count = nkern_counts[1]; pat_count > 0; pat_count--) {
        ...
        cVec13 = vfmaq_f32(cVec13, aVec, bVec3);
      ...
      for(int pat_count = nkern_counts[2]; pat_count > 0; pat_count--) {
        ...
        cVec23 = vfmaq_f32(cVec23, aVec, bVec3);
      ...
      for(int pat_count = nkern_counts[3]; pat_count > 0; pat_count--) {
        ...
        cVec33 = vfmaq_f32(cVec33, aVec, bVec3);
        ...
        const bool load_c)
    {
      ...
      if (load_c) {
        ...
        cVec02 = vld1q_f32(C0 + 2 * 4);
        cVec03 = vld1q_f32(C0 + 3 * 4);
        cVec10 = vld1q_f32(C1 + 4 * 4);
        cVec11 = vld1q_f32(C1 + 5 * 4);
        cVec12 = vld1q_f32(C1 + 6 * 4);
        cVec13 = vld1q_f32(C1 + 7 * 4);
        cVec20 = vld1q_f32(C2 + 8 * 4);
        cVec21 = vld1q_f32(C2 + 9 * 4);
        cVec22 = vld1q_f32(C2 + 10 * 4);
        cVec23 = vld1q_f32(C2 + 11 * 4);
        cVec30 = vld1q_f32(C3 + 12 * 4);
        cVec31 = vld1q_f32(C3 + 13 * 4);
        cVec32 = vld1q_f32(C3 + 14 * 4);
        cVec33 = vld1q_f32(C3 + 15 * 4);
      } else {
        cVec00 = vmovq_n_f32(0);
        cVec01 = vmovq_n_f32(0);
        cVec02 = vmovq_n_f32(0);
