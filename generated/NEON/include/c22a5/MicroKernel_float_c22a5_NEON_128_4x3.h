...
namespace sop {
struct MicroKernel_float_c22a5_NEON_128_4x3 {
    ...
    static constexpr const char* id = "c22a5_NEON_128_4x3";
        ...
        const bool load_c)
    {
      ...
      if (load_c) {
        ...
        cVec01 = vdupq_n_f32(0);
        cVec02 = vdupq_n_f32(0);
        cVec10 = vdupq_n_f32(0);
        cVec11 = vdupq_n_f32(0);
        cVec12 = vdupq_n_f32(0);
        cVec20 = vdupq_n_f32(0);
        cVec21 = vdupq_n_f32(0);
        cVec22 = vdupq_n_f32(0);
        cVec30 = vdupq_n_f32(0);
        cVec31 = vdupq_n_f32(0);
        cVec32 = vdupq_n_f32(0);
      }
      ...
      for(int pat_count = nkern_counts[0]; pat_count > 0; pat_count--) {
        ...
        cVec01 = vfmaq_f32(aVec, bVec1, cVec01);
        cVec02 = vfmaq_f32(aVec, bVec2, cVec02);
      ...
      for(int pat_count = nkern_counts[1]; pat_count > 0; pat_count--) {
        ...
        cVec11 = vfmaq_f32(aVec, bVec1, cVec11);
        cVec12 = vfmaq_f32(aVec, bVec2, cVec12);
      ...
      for(int pat_count = nkern_counts[2]; pat_count > 0; pat_count--) {
        ...
        cVec21 = vfmaq_f32(aVec, bVec1, cVec21);
        cVec22 = vfmaq_f32(aVec, bVec2, cVec22);
      ...
      for(int pat_count = nkern_counts[3]; pat_count > 0; pat_count--) {
        ...
        cVec31 = vfmaq_f32(aVec, bVec1, cVec31);
        cVec32 = vfmaq_f32(aVec, bVec2, cVec32);
