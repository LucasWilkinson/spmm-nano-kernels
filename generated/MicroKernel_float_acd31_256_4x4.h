...
namespace sop {
struct MicroKernel_float_acd31_256_4x4 {
    ...
    static uint16_t encode_nkern_pattern(uint16_t nkern_pat) {
        ...
        if (nkern_pat == 0b00001001) return 4;
        if (nkern_pat == 0b00001010) return 5;
        if (nkern_pat == 0b00001100) return 6;
        if (nkern_pat == 0b00000111) return 7;
    ...
    static uint16_t decode_nkern_pattern(uint16_t nkern_code) {
        ...
        if (nkern_code == 4) return 0b00001001;
        if (nkern_code == 5) return 0b00001010;
        if (nkern_code == 6) return 0b00001100;
    ...
    static constexpr const char* id = "acd31_256_4x4";
