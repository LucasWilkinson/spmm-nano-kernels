...
namespace sop {
struct MicroKernel_float_91aaa_512_4x4 {
    ...
    static uint16_t encode_nkern_pattern(uint16_t nkern_pat) {
        ...
        if (nkern_pat == 0b00001111) return 4;
    ...
    static uint16_t decode_nkern_pattern(uint16_t nkern_code) {
        ...
        if (nkern_code == 4) return 0b00001111;
