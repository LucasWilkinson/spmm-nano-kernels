...
namespace sop {
struct MicroKernel_float_80977_512_8x2 {
    ...
    static uint16_t encode_nkern_pattern(uint16_t nkern_pat) {
        ...
        if (nkern_pat == 0b01000000) return 1;
        if (nkern_pat == 0b00000010) return 2;
        if (nkern_pat == 0b00000100) return 3;
        if (nkern_pat == 0b10000000) return 4;
        if (nkern_pat == 0b00001000) return 5;
        if (nkern_pat == 0b00010000) return 6;
        if (nkern_pat == 0b11000011) return 7;
        if (nkern_pat == 0b10101010) return 8;
        if (nkern_pat == 0b00001111) return 9;
        if (nkern_pat == 0b11110000) return 10;
        if (nkern_pat == 0b01010101) return 11;
        if (nkern_pat == 0b00111100) return 12;
        if (nkern_pat == 0b11001111) return 13;
        if (nkern_pat == 0b11110011) return 14;
        if (nkern_pat == 0b11111100) return 15;
        if (nkern_pat == 0b00111111) return 16;
        if (nkern_pat == 0b11111111) return 17;
    ...
    static uint16_t decode_nkern_pattern(uint16_t nkern_code) {
        ...
        if (nkern_code == 1) return 0b01000000;
        if (nkern_code == 2) return 0b00000010;
        if (nkern_code == 3) return 0b00000100;
        if (nkern_code == 4) return 0b10000000;
        if (nkern_code == 5) return 0b00001000;
        if (nkern_code == 6) return 0b00010000;
        if (nkern_code == 7) return 0b11000011;
        if (nkern_code == 8) return 0b10101010;
        if (nkern_code == 9) return 0b00001111;
        if (nkern_code == 10) return 0b11110000;
        if (nkern_code == 11) return 0b01010101;
        if (nkern_code == 12) return 0b00111100;
        if (nkern_code == 13) return 0b11001111;
        if (nkern_code == 14) return 0b11110011;
        if (nkern_code == 15) return 0b11111100;
        if (nkern_code == 16) return 0b00111111;
        if (nkern_code == 17) return 0b11111111;
