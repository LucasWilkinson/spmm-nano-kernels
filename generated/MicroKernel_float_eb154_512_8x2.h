...
namespace sop {
struct MicroKernel_float_eb154_512_8x2 {
    ...
    static uint16_t encode_nkern_pattern(uint16_t nkern_pat) {
        ...
        if (nkern_pat == 0b00000011) return 7;
        if (nkern_pat == 0b11000000) return 8;
        if (nkern_pat == 0b00001100) return 9;
        if (nkern_pat == 0b00110000) return 10;
        if (nkern_pat == 0b10101010) return 11;
    ...
    static uint16_t decode_nkern_pattern(uint16_t nkern_code) {
        ...
        if (nkern_code == 7) return 0b00000011;
        if (nkern_code == 8) return 0b11000000;
        if (nkern_code == 9) return 0b00001100;
        if (nkern_code == 10) return 0b00110000;
        if (nkern_code == 11) return 0b10101010;
    ...
    static constexpr const char* id = "eb154_512_8x2";
