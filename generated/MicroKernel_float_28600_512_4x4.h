...
namespace sop {
struct MicroKernel_float_28600_512_4x4 {
    ...
    static uint16_t encode_nkern_pattern(uint16_t nkern_pat) {
        ...
        if (nkern_pat == 0b00000111) return 5;
        if (nkern_pat == 0b00001110) return 6;
    ...
    static uint16_t decode_nkern_pattern(uint16_t nkern_code) {
        ...
        if (nkern_code == 5) return 0b00000111;
        if (nkern_code == 6) return 0b00001110;
    ...
    static constexpr const char* id = "28600_512_4x4";
