...
namespace sop {
struct MicroKernel_float_520b4_512_4x4 {
    ...
    static uint16_t encode_nkern_pattern(uint16_t nkern_pat) {
        if (nkern_pat == 0b00000011) return 0;
        if (nkern_pat == 0b00000101) return 1;
        if (nkern_pat == 0b00000110) return 2;
        if (nkern_pat == 0b00001001) return 3;
        if (nkern_pat == 0b00001010) return 4;
        if (nkern_pat == 0b00001100) return 5;
        if (nkern_pat == 0b00001111) return 6;
    ...
    static uint16_t decode_nkern_pattern(uint16_t nkern_code) {
        if (nkern_code == 0) return 0b00000011;
        if (nkern_code == 1) return 0b00000101;
        if (nkern_code == 2) return 0b00000110;
        if (nkern_code == 3) return 0b00001001;
        if (nkern_code == 4) return 0b00001010;
        if (nkern_code == 5) return 0b00001100;
        if (nkern_code == 6) return 0b00001111;
    ...
    static uint16_t nnz_count_for_nkern_code(uint16_t nkern_code) {
        if (nkern_code == 0) return 2;
        if (nkern_code == 1) return 2;
        if (nkern_code == 2) return 2;
        if (nkern_code == 3) return 2;
        if (nkern_code == 4) return 2;
        if (nkern_code == 5) return 2;
        if (nkern_code == 6) return 4;
        if (nkern_code == sop::ZERO_PATTERN_ID) return 0; 
