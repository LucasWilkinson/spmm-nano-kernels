...
namespace sop {
struct MicroKernel_float_0dfe3_256_4x4 {
    ...
    static uint16_t encode_nkern_pattern(uint16_t nkern_pat) {
        ...
        if (nkern_pat == 0b00001010) return 6;
        if (nkern_pat == 0b00001101) return 7;
    ...
    static uint16_t decode_nkern_pattern(uint16_t nkern_code) {
        ...
        if (nkern_code == 6) return 0b00001010;
        if (nkern_code == 7) return 0b00001101;
    ...
    static constexpr const char* id = "0dfe3_256_4x4";
