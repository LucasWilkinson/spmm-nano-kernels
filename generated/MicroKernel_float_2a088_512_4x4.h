...
namespace sop {
struct MicroKernel_float_2a088_512_4x4 {
    ...
    static uint16_t encode_nkern_pattern(uint16_t nkern_pat) {
        if (nkern_pat == 0b00000010) return 0;
        if (nkern_pat == 0b00000100) return 1;
        if (nkern_pat == 0b00001000) return 2;
        if (nkern_pat == 0b00000011) return 3;
        if (nkern_pat == 0b00000101) return 4;
        if (nkern_pat == 0b00000110) return 5;
        if (nkern_pat == 0b00001001) return 6;
        if (nkern_pat == 0b00001010) return 7;
        if (nkern_pat == 0b00001100) return 8;
    ...
    static uint16_t decode_nkern_pattern(uint16_t nkern_code) {
        if (nkern_code == 0) return 0b00000010;
        if (nkern_code == 1) return 0b00000100;
        if (nkern_code == 2) return 0b00001000;
        if (nkern_code == 3) return 0b00000011;
        if (nkern_code == 4) return 0b00000101;
        if (nkern_code == 5) return 0b00000110;
        if (nkern_code == 6) return 0b00001001;
        if (nkern_code == 7) return 0b00001010;
        if (nkern_code == 8) return 0b00001100;
