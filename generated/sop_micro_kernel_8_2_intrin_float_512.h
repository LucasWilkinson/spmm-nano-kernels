...
template<> struct SOPMicroKernelIntrin<float, 512, 8, 2> {
        ...
        const bool load_c)
    {
      ...
      if (load_c) {
        cVec00 = _mm512_loadu_ps(C_temp + 0 * 16);
        cVec01 = _mm512_maskz_loadu_ps(last_reg_mask, C_temp + 1 * 16);
        C_temp += n;
        cVec10 = _mm512_loadu_ps(C_temp + 0 * 16);
        cVec11 = _mm512_maskz_loadu_ps(last_reg_mask, C_temp + 1 * 16);
        C_temp += n;
        cVec20 = _mm512_loadu_ps(C_temp + 0 * 16);
        cVec21 = _mm512_maskz_loadu_ps(last_reg_mask, C_temp + 1 * 16);
        C_temp += n;
        cVec30 = _mm512_loadu_ps(C_temp + 0 * 16);
        cVec31 = _mm512_maskz_loadu_ps(last_reg_mask, C_temp + 1 * 16);
        C_temp += n;
        cVec40 = _mm512_loadu_ps(C_temp + 0 * 16);
        cVec41 = _mm512_maskz_loadu_ps(last_reg_mask, C_temp + 1 * 16);
        C_temp += n;
        cVec50 = _mm512_loadu_ps(C_temp + 0 * 16);
        cVec51 = _mm512_maskz_loadu_ps(last_reg_mask, C_temp + 1 * 16);
        C_temp += n;
        cVec60 = _mm512_loadu_ps(C_temp + 0 * 16);
        cVec61 = _mm512_maskz_loadu_ps(last_reg_mask, C_temp + 1 * 16);
        C_temp += n;
        cVec70 = _mm512_loadu_ps(C_temp + 0 * 16);
        cVec71 = _mm512_maskz_loadu_ps(last_reg_mask, C_temp + 1 * 16);
        C_temp += n;
      } else {
        cVec00 = _mm512_setzero_ps();
        cVec01 = _mm512_setzero_ps();
      ...
      for(int pat_count = pattern_counts[0]; pat_count > 0; pat_count--) {
        __m512 aVec;
        __m512 bVec0 = _mm512_loadu_ps(B_curr + 0 * 16);
        __m512 bVec1 = _mm512_maskz_loadu_ps(last_reg_mask, B_curr + 1 * 16);
        B_curr = (*col_indices_curr) * n + B; col_indices_curr++;
        aVec = _mm512_set1_ps(*curr_value_ptr); curr_value_ptr++;
        cVec00 = _mm512_fmadd_ps(aVec, bVec0, cVec00);
        cVec01 = _mm512_fmadd_ps(aVec, bVec1, cVec01);
      ...
      _mm512_storeu_ps(C + 0 * n + 0 * 16, cVec00);
      _mm512_mask_storeu_ps(C + 0 * n + 1 * 16, last_reg_mask, cVec01);
      _mm512_storeu_ps(C + 1 * n + 0 * 16, cVec10);
      _mm512_mask_storeu_ps(C + 1 * n + 1 * 16, last_reg_mask, cVec11);
      _mm512_storeu_ps(C + 2 * n + 0 * 16, cVec20);
      _mm512_mask_storeu_ps(C + 2 * n + 1 * 16, last_reg_mask, cVec21);
      _mm512_storeu_ps(C + 3 * n + 0 * 16, cVec30);
      _mm512_mask_storeu_ps(C + 3 * n + 1 * 16, last_reg_mask, cVec31);
      _mm512_storeu_ps(C + 4 * n + 0 * 16, cVec40);
      _mm512_mask_storeu_ps(C + 4 * n + 1 * 16, last_reg_mask, cVec41);
      _mm512_storeu_ps(C + 5 * n + 0 * 16, cVec50);
      _mm512_mask_storeu_ps(C + 5 * n + 1 * 16, last_reg_mask, cVec51);
      _mm512_storeu_ps(C + 6 * n + 0 * 16, cVec60);
      _mm512_mask_storeu_ps(C + 6 * n + 1 * 16, last_reg_mask, cVec61);
      _mm512_storeu_ps(C + 7 * n + 0 * 16, cVec70);
      _mm512_mask_storeu_ps(C + 7 * n + 1 * 16, last_reg_mask, cVec71);
    ...
    __ALWAYS_INLINE static void panel_executor_masked_1(
        int m, int k, int n,
        const PanelUsingCounts& panel_desc,
        const float *__restrict__ B,
        float *__restrict__ C,
