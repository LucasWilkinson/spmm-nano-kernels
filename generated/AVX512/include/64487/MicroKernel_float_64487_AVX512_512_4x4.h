...
struct MicroKernel_float_64487_AVX512_512_4x4 {
    ...
    static constexpr int N_r = 4 * 16.0;
    ...
    static int max_acc_width_in_eles() { return 4 * 16.0; };
        ...
        const bool load_c)
    {
      ...
      if (load_c) {
        ...
        cVec02 = _mm512_loadu_ps(C + 2 * 16.0);
        cVec03 = _mm512_loadu_ps(C + 3 * 16.0);
        C_temp += N;
        cVec10 = _mm512_loadu_ps(C + 0 * 16.0);
        cVec11 = _mm512_loadu_ps(C + 1 * 16.0);
        cVec12 = _mm512_loadu_ps(C + 2 * 16.0);
        cVec13 = _mm512_loadu_ps(C + 3 * 16.0);
        C_temp += N;
        cVec20 = _mm512_loadu_ps(C + 0 * 16.0);
        cVec21 = _mm512_loadu_ps(C + 1 * 16.0);
        cVec22 = _mm512_loadu_ps(C + 2 * 16.0);
        cVec23 = _mm512_loadu_ps(C + 3 * 16.0);
        C_temp += N;
        cVec30 = _mm512_loadu_ps(C + 0 * 16.0);
        cVec31 = _mm512_loadu_ps(C + 1 * 16.0);
        cVec32 = _mm512_loadu_ps(C + 2 * 16.0);
        cVec33 = _mm512_loadu_ps(C + 3 * 16.0);
        C_temp += N;
      } else {
      ...
      for(int pat_count = nkern_counts[0]; pat_count > 0; pat_count--) {
        ...
        __m512 bVec2 = _mm512_loadu_ps(B_curr + 2 * 16.0);
        __m512 bVec3 = _mm512_loadu_ps(B_curr + 3 * 16.0);
      ...
      _mm512_storeu_ps(C + 0 * N + 2 * 16.0, cVec02);
      _mm512_storeu_ps(C + 0 * N + 3 * 16.0, cVec03);
      _mm512_storeu_ps(C + 1 * N + 0 * 16.0, cVec10);
      _mm512_storeu_ps(C + 1 * N + 1 * 16.0, cVec11);
      _mm512_storeu_ps(C + 1 * N + 2 * 16.0, cVec12);
      _mm512_storeu_ps(C + 1 * N + 3 * 16.0, cVec13);
      _mm512_storeu_ps(C + 2 * N + 0 * 16.0, cVec20);
      _mm512_storeu_ps(C + 2 * N + 1 * 16.0, cVec21);
      _mm512_storeu_ps(C + 2 * N + 2 * 16.0, cVec22);
      _mm512_storeu_ps(C + 2 * N + 3 * 16.0, cVec23);
      _mm512_storeu_ps(C + 3 * N + 0 * 16.0, cVec30);
      _mm512_storeu_ps(C + 3 * N + 1 * 16.0, cVec31);
      _mm512_storeu_ps(C + 3 * N + 2 * 16.0, cVec32);
      _mm512_storeu_ps(C + 3 * N + 3 * 16.0, cVec33);
