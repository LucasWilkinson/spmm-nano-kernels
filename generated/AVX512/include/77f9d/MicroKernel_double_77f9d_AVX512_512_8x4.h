...
namespace sop {
struct MicroKernel_double_77f9d_AVX512_512_8x4 {
        ...
        const bool load_c)
    {
      ...
      if (load_c) {
        ...
        cVec42 = _mm512d_loadu_pd(C4 + 2 * 8);
        cVec43 = _mm512d_loadu_pd(C4 + 3 * 8);
        cVec50 = _mm512d_loadu_pd(C5 + 0 * 8);
        cVec51 = _mm512d_loadu_pd(C5 + 1 * 8);
        cVec52 = _mm512d_loadu_pd(C5 + 2 * 8);
        cVec53 = _mm512d_loadu_pd(C5 + 3 * 8);
        cVec60 = _mm512d_loadu_pd(C6 + 0 * 8);
        cVec61 = _mm512d_loadu_pd(C6 + 1 * 8);
        cVec62 = _mm512d_loadu_pd(C6 + 2 * 8);
        cVec63 = _mm512d_loadu_pd(C6 + 3 * 8);
        cVec70 = _mm512d_loadu_pd(C7 + 0 * 8);
        cVec71 = _mm512d_loadu_pd(C7 + 1 * 8);
        cVec72 = _mm512d_loadu_pd(C7 + 2 * 8);
        cVec73 = _mm512d_loadu_pd(C7 + 3 * 8);
      } else {
        ...
        cVec42 = _mm512d_setzero_pd();
        cVec43 = _mm512d_setzero_pd();
        cVec50 = _mm512d_setzero_pd();
        cVec51 = _mm512d_setzero_pd();
        cVec52 = _mm512d_setzero_pd();
        cVec53 = _mm512d_setzero_pd();
        cVec60 = _mm512d_setzero_pd();
        cVec61 = _mm512d_setzero_pd();
        cVec62 = _mm512d_setzero_pd();
        cVec63 = _mm512d_setzero_pd();
        cVec70 = _mm512d_setzero_pd();
        cVec71 = _mm512d_setzero_pd();
        cVec72 = _mm512d_setzero_pd();
        cVec73 = _mm512d_setzero_pd();
      }
      ...
      for(int pat_count = nkern_counts[0]; pat_count > 0; pat_count--) {
        ...
        cVec72 = _mm512d_fmadd_pd(aVec, bVec2, cVec72);
        cVec73 = _mm512d_fmadd_pd(aVec, bVec3, cVec73);
      ...
      for(int pat_count = nkern_counts[5]; pat_count > 0; pat_count--) {
        ...
        cVec42 = _mm512d_fmadd_pd(aVec, bVec2, cVec42);
        cVec43 = _mm512d_fmadd_pd(aVec, bVec3, cVec43);
      ...
      for(int pat_count = nkern_counts[6]; pat_count > 0; pat_count--) {
        ...
        cVec52 = _mm512d_fmadd_pd(aVec, bVec2, cVec52);
        cVec53 = _mm512d_fmadd_pd(aVec, bVec3, cVec53);
      ...
      for(int pat_count = nkern_counts[7]; pat_count > 0; pat_count--) {
        ...
        cVec62 = _mm512d_fmadd_pd(aVec, bVec2, cVec62);
        cVec63 = _mm512d_fmadd_pd(aVec, bVec3, cVec63);
      ...
      _mm512d_storeu_pd(C4 + 2 * 8, cVec42);
      _mm512d_storeu_pd(C4 + 3 * 8, cVec43);
      _mm512d_storeu_pd(C5 + 0 * 8, cVec50);
      _mm512d_storeu_pd(C5 + 1 * 8, cVec51);
      _mm512d_storeu_pd(C5 + 2 * 8, cVec52);
      _mm512d_storeu_pd(C5 + 3 * 8, cVec53);
      _mm512d_storeu_pd(C6 + 0 * 8, cVec60);
      _mm512d_storeu_pd(C6 + 1 * 8, cVec61);
      _mm512d_storeu_pd(C6 + 2 * 8, cVec62);
      _mm512d_storeu_pd(C6 + 3 * 8, cVec63);
      _mm512d_storeu_pd(C7 + 0 * 8, cVec70);
      _mm512d_storeu_pd(C7 + 1 * 8, cVec71);
      _mm512d_storeu_pd(C7 + 2 * 8, cVec72);
      _mm512d_storeu_pd(C7 + 3 * 8, cVec73);
        ...
        const bool load_c)
    {
      ...
      if (load_c) {
        ...
        cVec40 = _mm512d_load_pd(C4 + 16 * 8);
        cVec41 = _mm512d_load_pd(C4 + 17 * 8);
        cVec42 = _mm512d_load_pd(C4 + 18 * 8);
        cVec43 = _mm512d_load_pd(C4 + 19 * 8);
        cVec50 = _mm512d_load_pd(C5 + 20 * 8);
        cVec51 = _mm512d_load_pd(C5 + 21 * 8);
        cVec52 = _mm512d_load_pd(C5 + 22 * 8);
        cVec53 = _mm512d_load_pd(C5 + 23 * 8);
        cVec60 = _mm512d_load_pd(C6 + 24 * 8);
        cVec61 = _mm512d_load_pd(C6 + 25 * 8);
        cVec62 = _mm512d_load_pd(C6 + 26 * 8);
        cVec63 = _mm512d_load_pd(C6 + 27 * 8);
        cVec70 = _mm512d_load_pd(C7 + 28 * 8);
        cVec71 = _mm512d_load_pd(C7 + 29 * 8);
        cVec72 = _mm512d_load_pd(C7 + 30 * 8);
        cVec73 = _mm512d_load_pd(C7 + 31 * 8);
      } else {
        cVec00 = _mm512d_setzero_pd();
        cVec01 = _mm512d_setzero_pd();
        cVec02 = _mm512d_setzero_pd();
