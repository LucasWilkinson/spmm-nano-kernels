...
struct MicroKernel_float_77f9d_AVX512_512_8x2 {
        ...
        const bool load_c)
    {
      ...
      if (load_c) {
        ...
        C_temp += N;
        cVec40 = _mm512_loadu_ps(C + 0 * 16.0);
        cVec41 = _mm512_loadu_ps(C + 1 * 16.0);
        C_temp += N;
        cVec50 = _mm512_loadu_ps(C + 0 * 16.0);
        cVec51 = _mm512_loadu_ps(C + 1 * 16.0);
        C_temp += N;
        cVec60 = _mm512_loadu_ps(C + 0 * 16.0);
        cVec61 = _mm512_loadu_ps(C + 1 * 16.0);
        C_temp += N;
        cVec70 = _mm512_loadu_ps(C + 0 * 16.0);
        cVec71 = _mm512_loadu_ps(C + 1 * 16.0);
        C_temp += N;
      } else {
      ...
      _mm512_storeu_ps(C + 4 * N + 0 * 16.0, cVec40);
      _mm512_storeu_ps(C + 4 * N + 1 * 16.0, cVec41);
      _mm512_storeu_ps(C + 5 * N + 0 * 16.0, cVec50);
      _mm512_storeu_ps(C + 5 * N + 1 * 16.0, cVec51);
      _mm512_storeu_ps(C + 6 * N + 0 * 16.0, cVec60);
      _mm512_storeu_ps(C + 6 * N + 1 * 16.0, cVec61);
      _mm512_storeu_ps(C + 7 * N + 0 * 16.0, cVec70);
      _mm512_storeu_ps(C + 7 * N + 1 * 16.0, cVec71);
