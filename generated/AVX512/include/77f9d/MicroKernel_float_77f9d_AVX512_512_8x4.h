...
namespace sop {
struct MicroKernel_float_77f9d_AVX512_512_8x4 {
    ...
    static constexpr const char* id = "77f9d_AVX512_512_8x4";
        ...
        const bool load_c)
    {
      ...
      float* C6 = C + 6 * N;
      float* C7 = C + 7 * N;
      __m512 cVec00, cVec01, cVec02, cVec03, cVec10, cVec11, cVec12, cVec13, cVec20, cVec21, cVec22, cVec23, cVec30, cVec31, cVec32, cVec33, cVec40, cVec41, cVec42, cVec43, cVec50, cVec51, cVec52, cVec53, cVec60, cVec61, cVec62, cVec63, cVec70, cVec71, cVec72, cVec73;
      if (load_c) {
        cVec00 = _mm512_loadu_ps(C0 + 0 * 16);
        cVec01 = _mm512_loadu_ps(C0 + 1 * 16);
        cVec02 = _mm512_loadu_ps(C0 + 2 * 16);
        cVec03 = _mm512_loadu_ps(C0 + 3 * 16);
        cVec10 = _mm512_loadu_ps(C1 + 0 * 16);
        cVec11 = _mm512_loadu_ps(C1 + 1 * 16);
        cVec12 = _mm512_loadu_ps(C1 + 2 * 16);
        cVec13 = _mm512_loadu_ps(C1 + 3 * 16);
        cVec20 = _mm512_loadu_ps(C2 + 0 * 16);
        cVec21 = _mm512_loadu_ps(C2 + 1 * 16);
        cVec22 = _mm512_loadu_ps(C2 + 2 * 16);
        cVec23 = _mm512_loadu_ps(C2 + 3 * 16);
        cVec30 = _mm512_loadu_ps(C3 + 0 * 16);
        cVec31 = _mm512_loadu_ps(C3 + 1 * 16);
        cVec32 = _mm512_loadu_ps(C3 + 2 * 16);
        cVec33 = _mm512_loadu_ps(C3 + 3 * 16);
        cVec40 = _mm512_loadu_ps(C4 + 0 * 16);
        cVec41 = _mm512_loadu_ps(C4 + 1 * 16);
        cVec42 = _mm512_loadu_ps(C4 + 2 * 16);
        cVec43 = _mm512_loadu_ps(C4 + 3 * 16);
        cVec50 = _mm512_loadu_ps(C5 + 0 * 16);
        cVec51 = _mm512_loadu_ps(C5 + 1 * 16);
        cVec52 = _mm512_loadu_ps(C5 + 2 * 16);
        cVec53 = _mm512_loadu_ps(C5 + 3 * 16);
        cVec60 = _mm512_loadu_ps(C6 + 0 * 16);
        cVec61 = _mm512_loadu_ps(C6 + 1 * 16);
        cVec62 = _mm512_loadu_ps(C6 + 2 * 16);
        cVec63 = _mm512_loadu_ps(C6 + 3 * 16);
        cVec70 = _mm512_loadu_ps(C7 + 0 * 16);
        cVec71 = _mm512_loadu_ps(C7 + 1 * 16);
        cVec72 = _mm512_loadu_ps(C7 + 2 * 16);
        cVec73 = _mm512_loadu_ps(C7 + 3 * 16);
      } else {
        ...
        cVec42 = _mm512_setzero_ps();
        cVec43 = _mm512_setzero_ps();
        cVec50 = _mm512_setzero_ps();
        cVec51 = _mm512_setzero_ps();
        cVec52 = _mm512_setzero_ps();
        cVec53 = _mm512_setzero_ps();
        cVec60 = _mm512_setzero_ps();
        cVec61 = _mm512_setzero_ps();
        cVec62 = _mm512_setzero_ps();
        cVec63 = _mm512_setzero_ps();
        cVec70 = _mm512_setzero_ps();
        cVec71 = _mm512_setzero_ps();
        cVec72 = _mm512_setzero_ps();
        cVec73 = _mm512_setzero_ps();
      }
      ...
      for(int pat_count = nkern_counts[0]; pat_count > 0; pat_count--) {
        ...
        cVec72 = _mm512_fmadd_ps(aVec, bVec2, cVec72);
        cVec73 = _mm512_fmadd_ps(aVec, bVec3, cVec73);
      ...
      for(int pat_count = nkern_counts[5]; pat_count > 0; pat_count--) {
        ...
        cVec42 = _mm512_fmadd_ps(aVec, bVec2, cVec42);
        cVec43 = _mm512_fmadd_ps(aVec, bVec3, cVec43);
      ...
      for(int pat_count = nkern_counts[6]; pat_count > 0; pat_count--) {
        ...
        cVec52 = _mm512_fmadd_ps(aVec, bVec2, cVec52);
        cVec53 = _mm512_fmadd_ps(aVec, bVec3, cVec53);
      ...
      for(int pat_count = nkern_counts[7]; pat_count > 0; pat_count--) {
        ...
        cVec62 = _mm512_fmadd_ps(aVec, bVec2, cVec62);
        cVec63 = _mm512_fmadd_ps(aVec, bVec3, cVec63);
      ...
      _mm512_storeu_ps(C0 + 2 * 16, cVec02);
      _mm512_storeu_ps(C0 + 3 * 16, cVec03);
      _mm512_storeu_ps(C1 + 0 * 16, cVec10);
      _mm512_storeu_ps(C1 + 1 * 16, cVec11);
      _mm512_storeu_ps(C1 + 2 * 16, cVec12);
      _mm512_storeu_ps(C1 + 3 * 16, cVec13);
      _mm512_storeu_ps(C2 + 0 * 16, cVec20);
      _mm512_storeu_ps(C2 + 1 * 16, cVec21);
      _mm512_storeu_ps(C2 + 2 * 16, cVec22);
      _mm512_storeu_ps(C2 + 3 * 16, cVec23);
      _mm512_storeu_ps(C3 + 0 * 16, cVec30);
      _mm512_storeu_ps(C3 + 1 * 16, cVec31);
      _mm512_storeu_ps(C3 + 2 * 16, cVec32);
      _mm512_storeu_ps(C3 + 3 * 16, cVec33);
      _mm512_storeu_ps(C4 + 0 * 16, cVec40);
      _mm512_storeu_ps(C4 + 1 * 16, cVec41);
      _mm512_storeu_ps(C4 + 2 * 16, cVec42);
      _mm512_storeu_ps(C4 + 3 * 16, cVec43);
      _mm512_storeu_ps(C5 + 0 * 16, cVec50);
      _mm512_storeu_ps(C5 + 1 * 16, cVec51);
      _mm512_storeu_ps(C5 + 2 * 16, cVec52);
      _mm512_storeu_ps(C5 + 3 * 16, cVec53);
      _mm512_storeu_ps(C6 + 0 * 16, cVec60);
      _mm512_storeu_ps(C6 + 1 * 16, cVec61);
      _mm512_storeu_ps(C6 + 2 * 16, cVec62);
      _mm512_storeu_ps(C6 + 3 * 16, cVec63);
      _mm512_storeu_ps(C7 + 0 * 16, cVec70);
      _mm512_storeu_ps(C7 + 1 * 16, cVec71);
      _mm512_storeu_ps(C7 + 2 * 16, cVec72);
      _mm512_storeu_ps(C7 + 3 * 16, cVec73);
        ...
        const bool load_c)
    {
      ...
      if (load_c) {
        ...
        cVec02 = _mm512_load_ps(C0 + 2 * 16);
        cVec03 = _mm512_load_ps(C0 + 3 * 16);
        cVec10 = _mm512_load_ps(C1 + 4 * 16);
        cVec11 = _mm512_load_ps(C1 + 5 * 16);
        cVec12 = _mm512_load_ps(C1 + 6 * 16);
        cVec13 = _mm512_load_ps(C1 + 7 * 16);
        cVec20 = _mm512_load_ps(C2 + 8 * 16);
        cVec21 = _mm512_load_ps(C2 + 9 * 16);
        cVec22 = _mm512_load_ps(C2 + 10 * 16);
        cVec23 = _mm512_load_ps(C2 + 11 * 16);
        cVec30 = _mm512_load_ps(C3 + 12 * 16);
        cVec31 = _mm512_load_ps(C3 + 13 * 16);
        cVec32 = _mm512_load_ps(C3 + 14 * 16);
        cVec33 = _mm512_load_ps(C3 + 15 * 16);
        cVec40 = _mm512_load_ps(C4 + 16 * 16);
        cVec41 = _mm512_load_ps(C4 + 17 * 16);
        cVec42 = _mm512_load_ps(C4 + 18 * 16);
        cVec43 = _mm512_load_ps(C4 + 19 * 16);
        cVec50 = _mm512_load_ps(C5 + 20 * 16);
        cVec51 = _mm512_load_ps(C5 + 21 * 16);
        cVec52 = _mm512_load_ps(C5 + 22 * 16);
        cVec53 = _mm512_load_ps(C5 + 23 * 16);
        cVec60 = _mm512_load_ps(C6 + 24 * 16);
        cVec61 = _mm512_load_ps(C6 + 25 * 16);
        cVec62 = _mm512_load_ps(C6 + 26 * 16);
        cVec63 = _mm512_load_ps(C6 + 27 * 16);
        cVec70 = _mm512_load_ps(C7 + 28 * 16);
        cVec71 = _mm512_load_ps(C7 + 29 * 16);
        cVec72 = _mm512_load_ps(C7 + 30 * 16);
        cVec73 = _mm512_load_ps(C7 + 31 * 16);
      } else {
        cVec00 = _mm512_setzero_ps();
        cVec01 = _mm512_setzero_ps();
        cVec02 = _mm512_setzero_ps();
